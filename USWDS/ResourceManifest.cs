    ...
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                ...
                .SetUrl("~/USWDS/vendor/jquery/jquery.min.js", "~/USWDS/vendor/jquery/jquery.js")
            ...
            manifest
                ...
                .SetUrl("~/USWDS/vendor/jquery/jquery.slim.min.js", "~/USWDS/vendor/jquery/jquery.slim.js")
            ...
            manifest
                ...
                .SetUrl("~/USWDS/vendor/bootstrap/js/bootstrap.min.js", "~/USWDS/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                ...
                .SetDependencies("TheBlogTheme-vendor-jQuery")
                .SetUrl("~/USWDS/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/USWDS/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                ...
                .SetUrl("~/USWDS/vendor/bootstrap/css/bootstrap.min.css", "~/USWDS/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                ...
                .SetUrl("~/USWDS/css/bootstrap-oc.min.css", "~/USWDS/css/bootstrap-oc.css")
                .SetVersion("1.0.0");

            manifest
                .DefineStyle("TheBlogTheme-vendor-font-awesome")
                .SetUrl("~/USWDS/vendor/fontawesome-free/css/all.min.css", "~/USWDS/vendor/fontawesome-free/css/all.css")
